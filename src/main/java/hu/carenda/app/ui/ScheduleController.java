...
public class ScheduleController {
    ...
    private static final double COL_WIDTH   = 110.0;
    ...
    @FXML
    public void onNew() {
        // új üres időpontot nyitunk a kiválasztott napra 10:00-ra
        var start = dayPicker.getValue().atTime(10, 0);
        var a = new Appointment();
        a.setStartTs(start.toString());
        a.setDurationMinutes(60);
        a.setStatus("PLANNED");
        // szerkesztő megnyitása – nálad egyparaméteres:
        Forms.appointment(a);
        // bezárás után újrarajzolás
        reload();
    }
    ...
    private Node makeBlock(Appointment a, double x, double y, double w, double h) {
        ...
        box.setOnMouseClicked(e -> {
            e.consume();
            Forms.appointment(a); // nálad egyparaméteres
            reload();             // bezárás után frissítünk
        });
